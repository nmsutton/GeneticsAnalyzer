...
if ON_OPENSHIFT:
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': 'hapmapdata', #os.path.join(os.environ['OPENSHIFT_DATA_DIR'], 'sqlite3.db'),  # Or path to database file if using sqlite3.
            'USER': 'adminap7ZHss',                      # Not used with sqlite3.
            'PASSWORD': 'pYcVeQbGD9fy',                  # Not used with sqlite3.
            'HOST': '127.9.80.129',                      # Set to empty string for localhost. Not used with sqlite3.
...
TEMPLATE_DIRS = (
    ...
    os.path.join(PROJECT_DIR, 'SNPMissingness/templates'),
